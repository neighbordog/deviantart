...
class Api(object):
    ...
    def __init__(self, client_id, client_secret, redirect_uri="", standard_grant_type="client_credentials",
    ...
    def auth_uri(self):
        ...
        """The authorization URL that should be provided to the user"""
    ...
    def get_deviation_metadata(self, deviationids, ext_submission=False, ext_camera=False, ext_stats=False,
                               ext_collection=False):

        """Fetch deviation metadata for a set of deviations

        :param deviationids: The deviationids you want metadata for
    ...
    def get_users(self, usernames):
        ...
        :param usernames: The usernames you want metadata for (max. 50)
        """
    ...
    def update_user(self, user_is_artist="",
                    artist_level="",
                    artist_specialty="",
                    real_name="",
                    tagline="",
    ...
    def get_friends(self, username, offset=0, limit=10):
        ...
        response = self._req('/user/friends/{}'.format(username), {'offset': offset, 'limit': limit})
    ...
    def post_status(self, body="", id="", parentid="", stashid=""):
        ...
        """Post a status
        :param body: The body of the status
    ...
    def get_comments(self, endpoint="deviation",
                     deviationid="",
                     commentid="",
                     username="",
                     statusid="",
    ...
    def send_note(self, to, subject="", body="", noetid=""):
        ...
        response = self._req('/notes/send', post_data={'to[]': to, 'subject': subject, 'body': body, 'noetid': noetid})
    ...
    def _req(self, endpoint, get_data=None, post_data=None):
    ...
    @staticmethod
    def _checkResponseForErrors(response):
